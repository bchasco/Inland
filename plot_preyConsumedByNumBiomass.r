tiff("plot_preyConsumedByNumBiomass.tiff", width=480, height=780, pointsize=14)
...
for(s in 1:3)
{
  ...
  if(s==1) mtext("Numbers (000)", side=3, line=1.5, cex.lab=1.3)
