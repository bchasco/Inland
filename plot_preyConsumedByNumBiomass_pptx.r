tiff("plot_preyConsumedByNumBiomass_pptx.tiff", width=780, height=780, pointsize=14)

#Number consumed by age, predator
par(mfcol=c(3,2), mai=c(0.5,1.5,0.4,0.2))
...
for(s in 1:3)
{
  ...
  if(s==1) mtext("Numbers (000)", side=3, line=0.5, cex=2)
  mtext(FramNames[s], side=2, line=7, cex=2)
  box()
}
